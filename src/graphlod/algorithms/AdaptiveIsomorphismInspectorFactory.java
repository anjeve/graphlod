 ...
 */
     ...
     *
     * @author Assaf
     * @see AdaptiveIsomorphismInspectorFactory
     * @since Jul 17, 2005
     */
    public class AdaptiveIsomorphismInspectorFactory
    {
        ...
        /**
         * Creates a new inspector, using the class isomorphism detection
         * algorithm.
         *
         * @param graph1
         * @param graph2
         */
        public static <V, E> GraphIsomorphismInspector createClassIsomorphismInspector(
                Graph<V, E> graph1,
                Graph<V, E> graph2)
        {
            ...
            EquivalenceComparatorChain<V, Graph<V, E>> vertexChainedChecker =
                    new EquivalenceComparatorChainBase<V, Graph<V, E>>(
                            degreeComparator);
            vertexChainedChecker.appendComparator(null);

            GraphIsomorphismInspector inspector =
                    new ClassesIsomorphismInspector (
                            graph1,
                            graph2,
