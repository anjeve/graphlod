 ...
 * @since Jul 29, 2005
 */
public class ClassesIsomorphismInspector<V, E>
     ...
     *                      UniformEquivalenceComparator will be used as default (always return true)
     */
    public ClassesIsomorphismInspector(
            Graph<V, E> graph1,
            Graph<V, E> graph2,
     ...
     *
     * @see ClassesIsomorphismInspector(Graph,Graph,EquivalenceComparator,EquivalenceComparator)
     */
    public ClassesIsomorphismInspector(
            Graph<V, E> graph1,
            Graph<V, E> graph2) {
